...
<head>
  ...
  <title>Public Dev Diary — Progress & Releases</title>
  <style>
    :root{
      --bg:#071428; /* deep navy */
      --panel:#0b3b73; /* darker blue panel */
      --muted:#a9c6ff;
      --glass: rgba(255,255,255,0.04);
      --accent: #0b6efd; /* primary blue */
      --accent-2: #4ea3ff;
      --card:#06203a;
      --text: #eaf2ff;
      --danger: #ff6b6b;
    ...
    *{box-sizing:border-box}
    ...
    .legend .row{display:flex;gap:8px;align-items:center;padding:8px 6px;border-radius:8px}
    .badge{display:inline-flex;align-items:center;gap:8px;padding:6px 8px;border-radius:999px;font-weight:700;font-size:12px}
    .badge.released{background:linear-gradient(90deg,#052b48,#0b6efd);box-shadow:0 6px 16px rgba(11,110,253,0.12)}
